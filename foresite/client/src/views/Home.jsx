    ...
    <div>
          ...
          {unrated.map((t) => (
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", gap: 10 }}>
                <div>
                  <div style={{ fontWeight: 800, fontSize: 17 }}>{t.merchant}</div>
                  <div style={{ fontSize: 13, fontWeight: 600, color: C.muted, marginTop: 3 }}>
                    {t.desc} · {t.cat}
      ...
      {rated.length > 0 && (
        <section>
          ...
          {(showAllRated ? rated : rated.slice(0, 5)).map((t) => {
            ...
            return (
              ...
              >
                <div>
                  <div style={{ fontWeight: 700, fontSize: 16 }}>{t.merchant}</div>
          ...
          {rated.length > 5 && (
            ...
            >
              {showAllRated ? "Show fewer" : `Show ${rated.length - 5} more`}
            </button>
          )}
        </section>
      )}
