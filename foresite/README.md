...
A spending accountability app. Transactions arrive from your bank, and *you* are the judge: rate every purchase green ("worth it"), yellow ("it's fine"), or red ("regret it"). Next time you spend at a merchant you've rated before, Foresite shows you your own history — and warns you before the regret does.
